                ...
                <div class="panel-heading" role="tab" id="headingTwo">
                    <h4 class="panel-title">
                        <a class="collapsed" role="button" data-toggle="collapse"
                           ...
                           aria-controls="collapseTwo">branding
                            <i class="fa fa-angle-right"></i>
                            <i class="fa fa-angle-down"></i>
                        </a>
                    </h4>
                ...
                <div class="panel-heading" role="tab" id="headingThree">
                    <h4 class="panel-title">
                        <a class="collapsed" role="button" data-toggle="collapse"
                           ...
                           aria-controls="collapseThree">business
                            <i class="fa fa-angle-right"></i>
                            <i class="fa fa-angle-down"></i>
                        </a>
                    </h4>
                ...
                <div class="panel-heading" role="tab" id="headingFour">
                    <h4 class="panel-title">
                        <a class="collapsed" role="button" data-toggle="collapse"
                           ...
                           aria-controls="collapseFour">design
                            <i class="fa fa-angle-right"></i>
                            <i class="fa fa-angle-down"></i>
                        </a>
                    </h4>
                ...
                <div class="panel-heading" role="tab" id="headingFive">
                    <h4 class="panel-title">
                        <a class="collapsed" role="button" data-toggle="collapse"
                           ...
                           aria-controls="collapseFive">Html
                            <i class="fa fa-angle-right"></i>
                            <i class="fa fa-angle-down"></i>
                        </a>
                    </h4>
                ...
                <div class="panel-heading" role="tab" id="headingSix">
                    <h4 class="panel-title">
                        <a class="collapsed" role="button" data-toggle="collapse"
                           ...
                           aria-controls="collapseSix">inspiration
                            <i class="fa fa-angle-right"></i>
                            <i class="fa fa-angle-down"></i>
                        </a>
                    </h4>
                ...
                <div class="panel-heading" role="tab" id="headingSeven">
                    <h4 class="panel-title">
                        <a class="collapsed" role="button" data-toggle="collapse"
                           ...
                           aria-controls="collapseSeven">javascript
                            <i class="fa fa-angle-right"></i>
                            <i class="fa fa-angle-down"></i>
                        </a>
                    </h4>
                ...
                <div class="panel-heading" role="tab" id="headingEight">
                    <h4 class="panel-title">
                        <a class="collapsed" role="button" data-toggle="collapse"
                           ...
                           aria-controls="collapseEight">mobile
                            <i class="fa fa-angle-right"></i>
                            <i class="fa fa-angle-down"></i>
                        </a>
                    </h4>
                ...
                <div class="panel-heading" role="tab" id="headingNine">
                    <h4 class="panel-title">
                        <a class="collapsed" role="button" data-toggle="collapse"
                           ...
                           aria-controls="collapseNine">ux desing
                            <i class="fa fa-angle-right"></i>
                            <i class="fa fa-angle-down"></i>
                        </a>
                    </h4>
                ...
                <div class="panel-heading" role="tab" id="headingTen">
                    <h4 class="panel-title">
                        <a class="collapsed" role="button" data-toggle="collapse"
                           ...
                           aria-controls="collapseTen">web development
                            <i class="fa fa-angle-right"></i>
                            <i class="fa fa-angle-down"></i>
                        </a>
                    </h4>
